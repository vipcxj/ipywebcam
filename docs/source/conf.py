...
# -*- coding: utf-8 -*-
#
# ipywebcam documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipywebcam', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipywebcamdoc'
...
latex_documents = [
    (master_doc, 'ipywebcam.tex', 'ipywebcam Documentation',
     'Xiaojing Chen', 'manual'),
]
